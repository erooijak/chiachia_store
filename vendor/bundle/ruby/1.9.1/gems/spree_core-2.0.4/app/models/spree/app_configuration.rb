...
module Spree
  class AppConfiguration < Preferences::Configuration
    ...
    preference :default_meta_description, :string, default: 'Chia Chia! Website - De natuurlijke energiedrank'
    preference :default_meta_keywords, :string, default: 'Chia zaden, energiedrank, energy, drink, natural, ChiaChia, biologisch, biological, lovin it, chia seeds, cinnamon, fresca, mojita, natuurlijk, gezond, healthy'
    ...
    preference :site_name, :string, default: 'Chia Chia! - De natuurlijke energiedrank'
    preference :site_url, :string, default: 'chiachia.eu'
    ...
    preference :mails_from, :string, :default => 'info@chiachia.eu'
    preference :mail_bcc, :string, :default => 'info@chiachia.eu'
